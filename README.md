...
Architecture, WidgetKit extensions, StoreKit 2 monetization. Before mobile I
spent two years across frontend and backend, so when an app needs more than a
client, I build that too.
...
`Swift 6` `SwiftUI` `SwiftData` `Swift Concurrency` `WidgetKit` `App Intents`
`StoreKit 2` `HealthKit` `Core ML` `Vision` `Clean Architecture` `MVVM`
`Swift Testing` — plus `TypeScript` `React` `Next.js` `Java` `Spring Boot`

### 📬 Reach me

[Portfolio](https://portfolio-swift.vercel.app/en) ·
[LinkedIn](https://www.linkedin.com/in/sergio-adrian-fern%C3%A1ndez) ·
[Email](mailto:sergioadrianfernandez02@gmail.com)
